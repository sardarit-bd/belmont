                    ...
                    <div className="mb-12">
                        <div className="flex items-center justify-center">
                            ...
                            <div className="flex flex-col items-center">
                                <div className={`w-16 h-16 rounded-full flex items-center justify-center ${currentStep >= 1 ? 'bg-purple-600' : 'bg-gray-300'
                                    } transition-colors`}>
                            ...
                            {/* Step 2 - Schedule */}
                            <div className="flex flex-col items-center">
                                <div className={`w-16 h-16 rounded-full flex items-center justify-center ${currentStep >= 2 ? 'bg-purple-600' : 'bg-gray-300'
                                    } transition-colors`}>
                                    <svg className="w-8 h-8 text-white" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                            ...
                            {/* Step 3 - Confirm */}
                            <div className="flex flex-col items-center">
                                <div className={`w-16 h-16 rounded-full flex items-center justify-center ${currentStep >= 3 ? 'bg-purple-600' : 'bg-gray-300'
                                    } transition-colors`}>
                                    <svg className="w-8 h-8 text-white" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    ...
                    <div className="bg-white rounded-2xl shadow-xl p-8">
                        ...
                        {currentStep === 1 && (
                            <div>
                                ...
                                <button
                                    onClick={nextStep}
                                    className="w-full mt-6 bg-purple-600 hover:bg-purple-700 text-white font-semibold py-3 px-6 rounded-lg transition-colors flex items-center justify-center gap-2"
                                >
                        ...
                        {currentStep === 2 && (
                            <div>
                                <div className="bg-purple-50 rounded-lg p-4 mb-6 flex items-start gap-3">
                                    ...
                                    <div>
                                        <h2 className="text-lg font-semibold text-gray-900">Pick Your Perfect Time</h2>
                            ...
                            <div>
                                ...
                                <div className="bg-purple-50 rounded-lg p-6 space-y-4 mb-6">
                                    <div>
                                        ...
                                        <p className="text-gray-900 font-semibold">{formData.fullName || 'Not provided'}</p>
                                    </div>

                                    <div>
                                        <p className="text-sm text-purple-600 font-medium">Phone</p>
                                        <p className="text-gray-900 font-semibold">{formData.phoneNumber || 'Not provided'}</p>
                                    </div>

                                    <div>
                                        <p className="text-sm text-purple-600 font-medium">Pickup Address</p>
                                        <p className="text-gray-900 font-semibold">{formData.pickupAddress || 'Not provided'}</p>
                                    </div>

                                    <div className="grid grid-cols-2 gap-4">
                                        <div>
                                            <p className="text-sm text-purple-600 font-medium">Date</p>
                                            <p className="text-gray-900 font-semibold">{formData.pickupDate || 'Not selected'}</p>
                                        </div>
                                        <div>
                                            <p className="text-sm text-purple-600 font-medium">Time</p>
                                            <p className="text-gray-900 font-semibold">{formData.preferredTime || 'Not selected'}</p>
                                        </div>
                                    </div>
